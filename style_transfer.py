...
iterate = 40000
DATA_PATH = '../data/dataset/food/'
SAVE_PATH = 'style_transfer_data/models/'
...
def get_args():
    ...
    parser.add_argument('--style', default=0.95, type=float,
                        help='Style weight')
    parser.add_argument('--content', default=0.05, type=float,
                        help='Content weight')
    ...
    parser.add_argument('--loadstyle', default='food', type=str,
                        help='Load pretrained style transfer model')
    parser.add_argument('--input_path', default='style_transfer_data/food.jpg', type=str,
                        help='test image path')
    parser.add_argument('--save_path', default='style_transfer_data/transfered.png', type=str,
...
def generate_image():
    ...
    test_im = [imageio.imread(FLAGS.input_path)]
    saver = tf.train.Saver(
        var_list=tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='style_net'))
    sessconfig = tf.ConfigProto()
    sessconfig.gpu_options.allow_growth = True
