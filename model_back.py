...
class NetG(nn.Module):
    def __init__(self, ngf, nz):
        ...
        self.layer1 = nn.Sequential(
            nn.ConvTranspose2d(nz, ngf * 8, kernel_size=5, stride=1, padding=0, bias=False),
        ...
        self.layer5 = nn.Sequential(
            nn.ConvTranspose2d(ngf, 3, 6, 3, 1, bias=False),
            nn.Tanh()
        )
...
class NetD(nn.Module):
    def __init__(self, ndf):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, ndf, kernel_size=6, stride=3, padding=1, bias=False),
            nn.BatchNorm2d(ndf),
